...
export const LoggedInRoutes = [
  ...
  <Stack.Screen name='RecipeDescription' component={Screens.RecipeDescription} />,
  <Stack.Screen name='CreateStep' component={Screens.CreateStep} />,
  <Stack.Screen name='CreateDiet' component={Screens.CreateDiet} />,
  <Stack.Screen name='CreateAllergy' component={Screens.CreateAllergy} />,
  <Stack.Screen name='Settings' component={Screens.Settings} />,
  <Stack.Screen name='EditProfile' component={Screens.EditProfile} />,
  <Stack.Screen name='EditProfilePicture' component={Screens.EditProfilePicture} />,
  ...
  <Stack.Screen name='Diets' component={Screens.DietaryPreferences} />,
  <Stack.Screen name='Allergies' component={Screens.AllergyPreferences} />,
  <Stack.Screen name='ProfileVisibility' component={Screens.ProfileVisibility} />,
  <Stack.Screen name='RecipeAllComments' component={Screens.RecipeAllComments} />,
  <Stack.Screen name='RecipeCommentReplies' component={Screens.RecipeCommentReplies} />,
  <Stack.Screen name='RecipeAllIngredients' component={Screens.RecipeAllIngredients} />,
  <Stack.Screen name='RecipeDirectionExpanded' component={Screens.RecipeDirectionExpanded} />,
  <Stack.Screen name='SavedRecipes' component={Screens.SavedRecipes} />,
  ...
  <Stack.Screen name='AddIngredientDetails' component={Screens.AddIngredientDetails} />,
]
